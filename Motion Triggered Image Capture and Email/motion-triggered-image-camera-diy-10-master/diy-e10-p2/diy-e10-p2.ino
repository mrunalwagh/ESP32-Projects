...
#define emailSenderAccount    "sender@email.com"    //To use send Email for Gmail to port 465 (SSL), less secure app option should be enabled. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword   "Password"

#define emailRecipient        "recipient1@email.com"
