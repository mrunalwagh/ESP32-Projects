/*************************************************************************************************************************************************
 *  TITLE: This sketch takes an image when motion is detected using a PIR sensor. The AM312 sensor is connected to pin 13 
 *  along with an interfacing circuit. Watch the video to learn more. *
 *
 *  By Frenoy Osburn
